...
#include "../QChatClient/socket_thread.h"
...
QT_MOC_LITERAL(3, 21, 6), // "Packet"
QT_MOC_LITERAL(4, 28, 6), // "packet"
QT_MOC_LITERAL(5, 35, 13) // "receivePacket"

    },
    "SocketThread\0newMsg\0\0Packet\0packet\0"
    "receivePacket"
};
...
void SocketThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SocketThread::*_t)(Packet );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketThread::newMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SocketThread::newMsg(Packet _t1)
{

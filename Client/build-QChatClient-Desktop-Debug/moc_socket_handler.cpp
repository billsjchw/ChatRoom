...
QT_MOC_LITERAL(5, 36, 9), // "newImgMsg"
QT_MOC_LITERAL(6, 46, 11), // "setInfoResp"
QT_MOC_LITERAL(7, 58, 13), // "basicUserInfo"
QT_MOC_LITERAL(8, 72, 14), // "detailUserInfo"
QT_MOC_LITERAL(9, 87, 13), // "receivePacket"
QT_MOC_LITERAL(10, 101, 10) // "sendPacket"

    },
    "SocketHandler\0newMsg\0\0Packet\0packet\0"
    "newImgMsg\0setInfoResp\0basicUserInfo\0"
    "detailUserInfo\0receivePacket\0sendPacket"
};
...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->newImgMsg((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 2: _t->setInfoResp((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 3: _t->basicUserInfo((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 4: _t->detailUserInfo((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        case 5: _t->receivePacket(); break;
        case 6: _t->sendPacket((*reinterpret_cast< Packet(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (SocketHandler::*_t)(Packet );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketHandler::newImgMsg)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            typedef void (SocketHandler::*_t)(Packet );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketHandler::basicUserInfo)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (SocketHandler::*_t)(Packet );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketHandler::detailUserInfo)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 1
void SocketHandler::newImgMsg(Packet _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void SocketHandler::basicUserInfo(Packet _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 4
void SocketHandler::detailUserInfo(Packet _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };

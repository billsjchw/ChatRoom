...
#include "../../qtclient_ref/src/client.h"
...
QT_MOC_LITERAL(1, 11, 14), // "newMessageRead"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 7) // "readMsg"

    },
    "chatClient\0newMessageRead\0\0readMsg"
};
...
void chatClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newMessageRead((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chatClient::newMessageRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void chatClient::newMessageRead(const QString & _t1)
{
